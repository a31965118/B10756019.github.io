...
<body bgcolor="#F4DECB">
<header id="header">
  <h1 style="text-align:center;font-family:Microsoft JhengHei;font-size:54px">產品資訊_修改</h1>
</header>
<div>
...
<div align=center >
要修改的bookISBN：<Input Type="text" Name="bookISBN" style="background-color:pink;"><p>
</div>
<p></p>
<p></p>
<p>修改成:</p>
...
<input type="button" value="修改" type="submit" onclick="form_b.action='book_update2.php';form_b.submit();"/><p></p>
