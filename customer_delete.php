...
<body bgcolor="#F4DECB">
<header id="header">
  <h1 style="text-align:center;font-family:Microsoft JhengHei;font-size:54px">顧客資訊_刪除</h1>
</header>
<div>
...
<div align=center >
要刪除的bookISBN：<Input Type="text" Name="cId" style="background-color:pink;"><p>
</div>
<p></p>
</form>

<input type="button" value="刪除" type="submit" onclick="form_b.action='customer_delete2.php';form_b.submit();"/><p></p>
